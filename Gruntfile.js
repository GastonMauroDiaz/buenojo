// Generated on 2015-10-29 using generator-jhipster 2.23.0
'use strict';
var fs = require('fs');
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            sass: {
                files: ['src/main/scss/**/*.{scss,sass}','src/main/webapp/bower_components/bootstrap-sass/**/*.{scss,sass}'],
                tasks: ['sass:server']
            }
        },
        autoprefixer: {
        ...
        jshint: {
            ...
            all: [
                ...
                'src/main/webapp/scripts/app/**/*.js',
                'src/main/webapp/scripts/appCustom/**/*.js',
        ...
        ngtemplates:    {
            dist: {
                cwd: 'src/main/webapp',
                src: ['scripts/app/**/*.html', 'scripts/components/**/*.html','scripts/appCustom/**/*.html',],
