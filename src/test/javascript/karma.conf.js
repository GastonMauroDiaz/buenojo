...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'main/webapp/bower_components/graphlib/dist/graphlib.core.js',
            'main/webapp/bower_components/dagre/dist/dagre.core.js',
            'main/webapp/bower_components/dagre/dist/dagre.core.min.js',
            ...
            'main/webapp/bower_components/dagre-d3/dist/dagre-d3.core.js',
            'main/webapp/bower_components/jquery-ui/jquery-ui.js',
            'main/webapp/bower_components/angular-dragdrop/src/angular-dragdrop.js',
            'main/webapp/bower_components/openlayers3/build/ol.js',
            'main/webapp/bower_components/angular-openlayers-directive/dist/angular-openlayers-directive.min.js',
            'main/webapp/bower_components/ev-emitter/ev-emitter.js',
            'main/webapp/bower_components/imagesloaded/imagesloaded.js',
            'main/webapp/bower_components/moment-duration-format/lib/moment-duration-format.js',
