...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "BuenOjo@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "BuenOjo API";

        private String description = "BuenOjo API documentation";
